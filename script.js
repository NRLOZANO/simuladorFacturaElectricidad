...
Para ello, deberás construir un sistema básico que calcule el valor a pagar por un cliente
utilizando exclusivamente funciones sin parámetros, todas con retorno, y declaradas de diferentes formas:
configdeclarativas, de expresión y funciones flecha.
